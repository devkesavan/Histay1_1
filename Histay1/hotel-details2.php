                    ...
                    ?>
	                  ...
	                  <tr>
	                    <td class="theme-item-page-rooms-table-type">
	                      <h5 class="theme-item-page-rooms-table-type-title"><?php echo $rooms_result['hotel_room_list'][$key]['name']; ?></h5>
	                      ...
	                      <main class="tt_gallery gallery">
                            ...
                            foreach($rooms_result['hotel_room_list'][$key]['hotel_room_images'] as $ivalue)
	                        {
                				...
                				<div class="<?php if($oimg == 1) echo "tbig"; if($oimg == 5) echo "tlast"; ?>">
                				    ...
                				    {
                				        ?>
                				        <a href="<?php echo $ivalue['room_image'];?>"><img src="<?php echo $ivalue['room_image'];?>" alt="Image"></a>
                				        <?php
                				    }
                				    ?>
                			    </div>
													...
													<div>
														<div>
															<p>₹<?php echo $rooms_result['hotel_room_list'][$key]['final_cost']; ?> 
																<span style="text-decoration: line-through;">₹<?php echo $rooms_result['hotel_room_list'][$key]['actual_cost']; ?></span> / Per night</p>
														</div>
													</div>
													<button type="submit" name="add_to_cart" class="btn btn-primary-inverse btn-block tt_abtn">+ Add this room</a>
												</form>
	                  	</td>
	                  	<?php
	                  	if($ntd == 1)
		...
		$.ajax({
			...
			{	
				if(response == 1)
					...
					alert('Please check max Adults & Childrens!');
			},
