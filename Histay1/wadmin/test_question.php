...
if(isset($_SESSION['admin_uid']))
{
	...
	$page_title = "Master Online Test";
	$sub_page_title = "Master Online Test";
	$msg_title = "Master Online Test";
	$THIS_TABLE = $test_questions_table;
	...
	if(isset($_POST['action']))
	{
		...
		if($_POST['action'] == 'ac_add')
		{
			...
			$select_query = " select id from $THIS_TABLE where status!='E' ";
			$result = $con->query($select_query) or die(mysqli_error($con));
			if($result->num_rows == 0)
			{
				$insert_query = "insert into $THIS_TABLE(test_id,question,option1,option2,option3,option4,correct_option,possitive_mark,negative_mark,created_at,created_by,status)VALUES('$test_id','$question','$option1','$option2','$option3','$option4','$possitive_mark','$negative_mark','$created_at','$created_by','$status')";
				...
				if($inst_res === true ){
					...
					$response['message'] = 'Questions Not Added!';
				}
			} else {
				$response['status'] = 'error';
				$response = 'Questions Already exists!';
			}
		...
		if($_POST['action'] == 'ac_edit')
		{
			...
			$update_sql = "update $THIS_TABLE set test_id='$test_id',question='$question',option1='$option1',option2='$option2',option3='$option3',option4='$option4',possitive_mark='$possitive_mark',negative_mark='$negative_mark',updated_at='$updated_at',updated_by='$updated_by' where id='$id'";
			...
			if($up_res === true) {
				...
				$response['status'] = 'error';
				$response['message'] = 'Questions are Not Updated!';
			}
			echo json_encode($response);
		}
		//viewdata fetch
		...
		if($_POST['action'] == 'ac_change_status')
		{
			if($_POST['id'])
			{
				...
				if($res === true ){
					$response['status'] = 'success';
					$response['message'] = 'Questions Status changed successfully!';
				} else {
					$response['status'] = 'error';
					$response['message'] = 'Questions Status NOT changed.';
				}
				echo json_encode($response);
			}
	  }
		...
		if($_POST['action'] == 'ac_delete')
		{
			if($_POST['id']){
				...
				if($res === true ){
					$response['status'] = 'success';
					$response['message'] = 'Questions Record deleted Successfuly...';
				} else {
					$response['status'] = 'error';
		 			...
		 			if($result->num_rows > 0){
		 				while($data = $result->fetch_array()) {
							...
							echo "<tr>
									...
									<td> $data[possitive_mark]</td>
									<td> $data[negative_mark]</td>
		 					...
		 					echo "<tr colspan='7'><td>No Questions found.</td></tr>";
		 				}
		 			?>
		 		</tbody>
		 	  </table>
						...
						<form id="register_form" method="POST" autocomplete="off">
						    <div class="modal-body row">
						    	<div class="form-group row col-md-12">
									<label class="col-form-label text-md-right col-12 col-md-2 col-lg-2">Test Name</label>
									<div class="col-sm-12 col-md-10">
									 <div class="input-group">
										...
										<option value="0">Select Test</option>
										 <?php
											$select_query = "select id,name from $master_online_test_table where status!='E'";
                                        	$result = $con->query($select_query) or die(mysqli_error($con));
                                        	while($data = $result->fetch_array())
                                       		{
						    	...
						    	<div class="ques_data row">									
									<div class="form-group row col-md-12">
										<label class="col-form-label text-md-right col-12 col-md-2 col-lg-2">Questions</label>
										<div class="col-sm-12 col-md-10">
										 <div class="input-group">
											<div class="input-group-prepend">
											  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
											</div>
											<textarea rows="4" type="text" id="question" name="question[]" class="form-control"></textarea> 
										  </div>
										</div>
									</div>
									<div class="form-group row col-md-6">
										<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Option 1</label>
									...
									<div class="form-group row col-md-6">
										<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Option 2</label>
										<div class="col-sm-12 col-md-9">
										 <div class="input-group">
											<div class="input-group-prepend">
											  <div class="input-group-text"> <i class="fas fa-pencil-alt"></i> </div>
									...
									<div class="form-group row col-md-6">
										<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Option 3</label>
										<div class="col-sm-12 col-md-9">
										 <div class="input-group">
											<div class="input-group-prepend">
											  <div class="input-group-text"><i class="fas fa-pencil-alt"></i></div>
									...
									<div class="form-group row col-md-6">
										<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Option 4</label>
										<div class="col-sm-12 col-md-9">
										 <div class="input-group">
											<div class="input-group-prepend">
											  <div class="input-group-text"> <i class="fas fa-pencil-alt"></i> </div>
									...
									<div class="form-group row col-md-4">
										<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Correct Option</label>
										<div class="col-sm-12 col-md-9">
										 <div class="input-group">
											<div class="input-group-prepend">
											  <div class="input-group-text"> <i class="fas fa-pencil-alt"></i> </div>
											</div>
											<select class="form-control" name="correct_option[]" id="correct_option" required/>
												<option value="0">Select Test</option>
									...
									<div class="form-group row col-md-4">
										<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Possitive Mark</label>
										<div class="col-sm-12 col-md-9">
										 <div class="input-group">
											<div class="input-group-prepend">
											  <div class="input-group-text"> <i class="fas fa-pencil-alt"></i> </div>
											</div>
											<input type="text" id="possitive_mark" name="possitive_mark[]" class="form-control" required />
										  </div>
										</div>
									</div>
									<div class="form-group row col-md-4">
										<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Negative Mark</label>
										<div class="col-sm-12 col-md-9">
										 <div class="input-group">
											<div class="input-group-prepend">
											  <div class="input-group-text"> <i class="fas fa-pencil-alt"></i> </div>
											</div>
											<input type="text" id="negative_mark" name="negative_mark[]" class="form-control" required />
										  </div>
										</div>
									</div>
								</div>
								<div class="add_ques row"></div>
								<div class="modal-footer bg-whitesmoke br" style="margin: 0 auto;">
									<input type="hidden" id="id" name="id" value="0" />
									<input type="hidden" id="page" name="page" value="master" />
									<input type="hidden" id="action" name="action" value="ac_add" />
									<input type="button" name="add_multiple" id="add_multiple" class="btn btn-auth-color" value="ADD +" />
	...
	<script>
		...
		$(document).on('click','#add_multiple', function(event){
			var $ques_data = $('.ques_data').clone();
			$('.add_ques').html($ques_data);
		});		
