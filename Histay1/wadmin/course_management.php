...
if(isset($_SESSION['admin_uid']))
{
	...
	$page_title = "Courses";
	$sub_page_title = "Courses";
	$msg_title = "Courses";
	$THIS_TABLE = $course_management_table;
	...
	if(isset($_POST['action']))
	{
		...
		if($_POST['action'] == 'ac_add')
		{
			...
			{
				$insert_query = "insert into $THIS_TABLE(cat_id,code,name,short_description,description,syllabus,image,video,actual_cost,final_cost,course_include,tests,lession,skill_level,certificate,language,sort_no,created_at,created_by,status)
								values('$cat_id','$code','$name','$short_description','$description','$syllabus','$image','$video','$actual_cost','$final_cost','$course_include','$tests','$lession','$skill_level',
								'$certificate','$language','$sort_no','$created_at','$created_by','$status')";
		...
		if($_POST['action'] == 'ac_edit')
		{
			...
			$update_sql = "update $THIS_TABLE set cat_id='$cat_id',code='$code',name='$name',short_description='$short_description',description='$description',
							syllabus='$syllabus',image='$image',video='$video',actual_cost='$actual_cost',final_cost='$final_cost',course_include='$course_include',
							tests='$tests',lession='$lession',certificate='$certificate',language='$language',sort_no='$sort_no',updated_at='$updated_at',updated_by='$updated_by' where id='$id'";
		...
		if($_POST['action'] == 'ac_delete')
		{
			if($_POST['id']){
				...
				if($res === true ){
					$response['status'] = 'success';
					$response['message'] = 'Course Record deleted Successfuly...';
				} else {
					$response['status'] = 'error';
					...
					<div class="col-sm-12 col-md-9">
					 <div class="input-group">
						...
						<select class="form-control" name="cat_id" id="cat_id">
							...
							<?php
						 	$select_query = "select id,name from $course_category_table where status!='E'";
                        	$result = $con->query($select_query) or die(mysqli_error($con));
			...
			<script>
		 	...
		 	<div class="table-responsive">
		 	  <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
				...
				{
					if($_POST['cat_id'] != "")
						$filter .= " and cm.cat_id='$_POST[cat_id]' ";
					if($_POST['course_name'] != "")
						$filter .= " and cm.name like '%$_POST[course_name]%' ";
				}

	 			$select_query = "SELECT cc.id,cc.name as category_name,cm.* FROM $THIS_TABLE cm INNER JOIN $course_category_table cc ON cc.id=cm.cat_id WHERE cc.status!='E' $filter";
	 			$result = $con->query($select_query) or die(mysqli_error($con));
	 			if($result->num_rows > 0){
	 				while($data = $result->fetch_array()) {
	 					if($data['status'] == "A") {
	 					...
	 					if($data['certificate'] == "Y") {
		 						$certificate = '<span class="badge badge-success badge-shadow">YES</span>';
		 					}else if($data['certificate'] == "N"){
		 						$certificate = '<span class="badge badge-danger badge-shadow">NO</span>';
							}
								...
								<div class="form-group row col-md-6">
									...
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										...
										<textarea type="text" id="short_description" name="short_description" class="form-control" placeholder="short description" required /></textarea> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									...
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										...
										<textarea rows="4" type="text" id="description" name="description" class="form-control" placeholder="description" /></textarea> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Syllabus</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<div class="input-group-prepend">
										  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
										</div>
										<textarea type="text" id="syllabus" name="syllabus" class="form-control" placeholder="syllabus"></textarea> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
								...
								<div class="form-group row col-md-6">
									...
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										...
										<input type="text" id="video" name="video" class="form-control" placeholder="video" /> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									...
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										...
										<input type="number" id="actual_cost" name="actual_cost" class="form-control" placeholder="actual_cost" required /> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									...
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										...
										<input type="number" id="final_cost" name="final_cost" class="form-control" placeholder="final cost" required /> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Course Include</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<div class="input-group-prepend">
										  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
										</div>
										<textarea rows="4" type="text" id="course_include" name="course_include" placeholder="Eg: Full lifetime access,Certificate of Completion	" class="form-control" ></textarea> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tests</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<div class="input-group-prepend">
										  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
										</div>
										<input type="number" id="tests" name="tests" class="form-control" placeholder="tests" /> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Lessions</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<div class="input-group-prepend">
										  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
										</div>
										<input type="text" id="lession" name="lession" class="form-control" placeholder="lessions" /> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Skill Level</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<div class="input-group-prepend">
										  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
										</div>
										<input type="text" id="skill_level" name="skill_level" class="form-control" placeholder="skill Level" required /> 
									  </div>
									</div>
								</div>
								<div class="form-group row col-md-6">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Certificate</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<p class="input-group-text">
										<label><input type="radio" id="certificate_y" name="certificate" value="Y" required /> Yes</label>&nbsp&nbsp&nbsp
										<label><input type="radio" id="certificate_n" name="certificate" value="N" required /> No</label>
										</p>
										</div>
									</div>
								</div>
	...
	<script>
		...
		$(document).on('click','.edit', function(event){
			...
			success:function(data)
			{
				...
				$('#course_include').val(data.course_include);
				$('#tests').val(data.tests);
				$('#lession').val(data.lession);
				$('#skill_level').val(data.skill_level);
				$('#certificate_y').attr('checked',false);
				$('#certificate_n').attr('checked',false);
				if(data.certificate == "N")
					$('#certificate_n').attr('checked',true);
				else if(data.certificate == "Y")
					$('#certificate_y').attr('checked',true);
