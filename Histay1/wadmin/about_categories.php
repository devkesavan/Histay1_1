...
if(isset($_SESSION['admin_uid']))
{
	...
	$page_title = "About Category";
	$sub_page_title = "About Category";
	$msg_title = "About Category";
	$THIS_TABLE = $about_category_table;
	...
	if(isset($_POST['action']))
	{
		...
		if($_POST['action'] == 'ac_add')
		{
			...
			{
				$insert_query = "insert into $THIS_TABLE(parent_id,name,description,sort_no,featured_cat,cat_image,created_at,created_by,status)
												values('$parent_id','$name','$description','$sort_no','$featured_cat','$cat_image','$created_at','$created_by','$status')";
		...
		if($_POST['action'] == 'ac_edit')
		{
			...
			$update_sql = "update $THIS_TABLE set parent_id='$parent_id',name='$name',description='$description',sort_no='$sort_no',
							featured_cat='$featured_cat',cat_image='$cat_image',updated_at='$updated_at',updated_by='$updated_by' where id='$id'";
		 		...
		 		<?php
		 			...
		 			if($result->num_rows > 0){
		 				while($data = $result->fetch_array()) {
		 					...
		 					if($data['featured_cat'] == "Y") {
		 						$featured_cat = '<span class="badge badge-success badge-shadow">YES</span>';
		 					}else if($data['featured_cat'] == "N"){
		 						$featured_cat = '<span class="badge badge-danger badge-shadow">NO</span>';
							}
						...
						<form id="register_form" method="POST" autocomplete="off">
						    <div class="modal-body">
								<div class="form-group row mb-4">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Parent Name</label>
								...
								<div class="form-group row mb-4">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Featured Cat</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<div class="input-group-prepend">
										  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
										...
										<p>
										<label><input type="radio" id="featured_cat_y" name="featured_cat" value="Y" required /> Yes</label>&nbsp&nbsp&nbsp
										<label><input type="radio" id="featured_cat_n" name="featured_cat" value="N" required /> No</label>
										</p>
									  </div>
									</div>
								</div>
								<div class="form-group row mb-4">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Cat Image</label>
									<div class="col-sm-12 col-md-9">
									 <div class="input-group">
										<div class="input-group-prepend">
										  <div class="input-group-text"> <i class="fas fa-map-pin"></i> </div>
										</div>
										<input type="text" id="cat_image" name="cat_image" class="form-control" />
									  </div>
									</div>
								</div>
	...
	<script>
		...
		$(document).on('click','.edit', function(event){
			...
			success:function(data)
			{
				...
				if(data.featured_cat == "N")
					$('#featured_cat_n').attr('checked',true);
				else if(data.featured_cat == "Y")
					$('#featured_cat_y').attr('checked',true);
